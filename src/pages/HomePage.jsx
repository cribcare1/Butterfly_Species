...
//           const baseUrl = img.imageUrl || null;
//           return (
//             <div key={i} style={{ minWidth: '100%', position: 'relative', height: 420, flexShrink: 0, background: '#0a0a0a' }}>
//               {baseUrl ? (
//                 <img
//                   src={baseUrl}
//                   alt={img.display_name}
...
//                     display: 'block',
//                     // objectPosition removed — not needed for contain
//                   }}
//                   onError={e => {
//                     console.error('[Carousel] img failed:', baseUrl);
//                     e.target.style.display = 'none';
          ...
          return (
            <div
              ...
              style={{
                ...
                position: 'relative',
                flexShrink: 0,
                lineHeight: 0,         // removes inline-block gap under img
              }}
            >
              {baseUrl ? (
                <img
